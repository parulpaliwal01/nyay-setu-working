                                    ...
                                    <div style={{ flex: 1 }}>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
                                            ...
                                            {isToday && hearing.isUpcoming && (
                                                <span style={{ padding: '0.25rem 0.75rem', borderRadius: '1rem', background: 'rgba(74, 222, 128, 0.1)', color: '#22c55e', fontSize: '0.65rem', fontWeight: '800' }}>{t('hearings.today')}</span>
                                            )}
                                        </div>
